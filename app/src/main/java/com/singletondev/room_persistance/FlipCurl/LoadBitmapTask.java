...
public final class LoadBitmapTask implements Runnable {
    ...
    private LoadBitmapTask(Context context) {
        ...
        mPortraitBGs = new int[][] {
                new int[] {R.drawable.hukum_480, R.drawable.keutamaan_480, R.drawable.rukun_480,
                        R.drawable.syarat_480},
                new int[] {R.drawable.hukum_720, R.drawable.keutamaan_720, R.drawable.rukun_720,
                        R.drawable.syarat_720},
                new int[] {R.drawable.hukum_720, R.drawable.keutamaan_720,
                        R.drawable.rukun_720, R.drawable.syarat_720}
        };
    }
...
//        }
        ...
        Log.e("currentNumb",String.valueOf(newNo));
        mPreRandomNo = newNo;
